...
!! Limitation of Current Version (12/05/2025) !!
! - RCCX and GEO_Resolution_in_Degree must be the same as 5 degree.
...
!! 3-D SPATIAL RESOLUTIONS !!
   ...
   real*8, parameter  ::      RadialRange_min                = 1.0                         ! unit Re
   real*8, parameter  ::      RadialRange_max                = 5.0
   real*8, parameter  ::      dR                             = 0.2
...
!   character*70, parameter :: BC_dir                           = "/home/sylee/exospherecode/TIMEGCM/BC/"  
   ...
   character*70, parameter :: outdir                           = "/nobackup/slee122/MATE/Luna/"
...
!!***** The parameters below are determined by the values defined above *****!!
   ...
   integer, parameter :: beta_res = Beta_CX_GEO_Resolution_in_Degree      ! 5-degree resolution for both LON & LAT
   integer, parameter :: beta_tb_res = Beta_CX_Time_Resolution_in_Minute*60  ! Time resolution for BC (5-min resolution = 300s)
   integer, parameter :: nRadial_CX = Beta_CX_nRadial
   integer, parameter :: nLon_CX = 360/beta_res, nLat_CX = 180/beta_res+1        ! 360-longitude and 180-latitude degree
   integer, parameter :: ntperday_CX = 86400/beta_tb_res                  ! Total number of time grid for BC
   integer, parameter :: nt_bwd_CX = Start_Time_in_YYYYDOY - Beta_CX_Start_Time_in_YYYYDOY    ! # of days earlier than start_doy for BC
