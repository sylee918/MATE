...
!!**** Recommended to change the parameters for your run ***!!
   ...
   !! TIME SETTING !!
      integer, parameter ::      Start_Time_in_YYYYDOY          = 2010079
      integer, parameter ::      End_Time_in_YYYYDOY            = 2010079
   ...
   !! Exobase Boundary Condition (BC) Setting !!
      ...
      integer, parameter ::      BC_Start_Time_in_YYYYDOY         = 2010079                    ! BC covers from this time: A few days before {Start_Time_in_YYYYDOY} for tracing.
