...
!! TIME SETTING !!
   integer, parameter ::      Start_Time_in_YYYYDOY          = 1000007
   integer, parameter ::      End_Time_in_YYYYDOY            = 1000007
...
!! Exobase Boundary Condition (BC) Setting !!
   ...
   integer, parameter ::      BC_Start_Time_in_YYYYDOY         = 1000007                    ! BC covers from this time: A few days before {Start_Time_in_YYYYDOY} for tracing.
